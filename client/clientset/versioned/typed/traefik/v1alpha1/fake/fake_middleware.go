...
var middlewaresResource = schema.GroupVersionResource{Group: "traefik", Version: "v1alpha1", Resource: "middlewares"}

var middlewaresKind = schema.GroupVersionKind{Group: "traefik", Version: "v1alpha1", Kind: "Middleware"}
