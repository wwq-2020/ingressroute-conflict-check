...
var ingressroutesResource = schema.GroupVersionResource{Group: "traefik", Version: "v1alpha1", Resource: "ingressroutes"}

var ingressroutesKind = schema.GroupVersionKind{Group: "traefik", Version: "v1alpha1", Kind: "IngressRoute"}
